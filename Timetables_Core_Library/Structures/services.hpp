...
namespace Timetables {
	namespace Structures {
		...
		private:
			...
			std::array<bool, 7> operating_days_; // True at i-th position = the service is operating on this weekday.
		...
		public:
			...
			inline bool is_operating_on_day(std::size_t day) const { return operating_days_.at(day); } // Determines whether the service is operating on given day.
